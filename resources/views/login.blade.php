...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<body>
		<main class="h-[100dvh] flex justify-center items-center">
			<form class="space-y-5 shadow-xl px-5 py-10 bg-base-200 rounded-md" action="/v1/api/login" method="POST">
        @csrf
        ...
        <div class="space-y-2">
          ...
          <div>
            <label class="input validator">
              ...
              <input name="password" id="email" type="password" minlength="3" required placeholder="Password" />
            </label>
        ...
        <div class="flex justify-end gap-2">
          <a href="/signup">
            <button type="button" class="btn btn-sm btn-link">Signup</button>
          </a>
